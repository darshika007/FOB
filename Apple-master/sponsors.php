...
{
  $target = "img/sponsors/".basename($_FILES["file1"]["name"]);
  $file1=$_FILES['file1']['name'];
  $error = $_FILES['file1']['error'];
  $imgtype=$_FILES['file1']['type'];
  $ext= GetImageExtension($imgtype);
  $sname=$_POST['sname'];
  $sql = "INSERT INTO  sponser (file1,sname)values('$file1','$sname')";
...
//end delete query
                        ...
                        while ($row = mysqli_fetch_array($query)) {
                          $imageURL='img/sponsors/'. $row['file1'];
                    ?>
                           <tr>
